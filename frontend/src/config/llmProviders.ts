...
export const LLM_PROVIDERS: Record<LLMProvider, ProviderConfig> = {
  ...
  inputPricing: 1.50,
  outputPricing: 12,
  capabilities: ['chat', 'vision', 'function_calling', 'json_mode', 'streaming', 'auto-completion'],
  description: 'Next-generation Gemini model, optimized for high-complexity tasks and advanced reasoning',
  isNew: true
},
{
  id: 'gemini-3-lightning-preview-10-20',
  name: 'Gemini 3 Lightning',
  provider: 'google',
  contextWindow: 2000000,
  maxOutput: 131072,
  inputPricing: 0.20,
  outputPricing: 0.8,
  capabilities: ['chat', 'vision', 'function_calling', 'json_mode', 'streaming', 'auto-completion'],
  description: 'Ultra-fast Gemini 3 variant, designed for rapid responses with streamlined capabilities',
  isNew: true
},
      {
  ...
  outputPricing: 10,
  capabilities: ['chat', 'vision', 'function_calling', 'json_mode', 'streaming'],
  description: 'Most capable Gemini model, best for complex tasks',
  isNew: true,
},
{
  ...
  outputPricing: 0.6,
  capabilities: ['chat', 'vision', 'function_calling', 'json_mode', 'streaming'],
  description: 'Fast and efficient Gemini 2.5, great balance of speed and capability',
  isNew: true,
},
      {
